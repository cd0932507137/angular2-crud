...
export class AppComponent {
  ...
  Edit(formData){
    ...
    this.myForm.controls['username'].setValue(formData.username);
  ...
  Update(){
    let formValue = this.myForm.getRawValue();
    let index = this.DataArray.findIndex(data => data.name == formValue.name);
    this.DataArray[index].name = formValue.name;
    this.DataArray[index].username = formValue.username;
  ...
  //del
  Delete(dataForm){
    let index = this.DataArray.findIndex(data => data.name == dataForm.name);
